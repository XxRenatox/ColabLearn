...
export const AdminGroupsSection = ({
  groupsState,
  search,
  statusFilter,
  onSearchChange,
  ...
  const handleExport = () => {
    if (onExport) {
      ...
      toast.info('Exportar grupos', 'La funcionalidad de exportación estará disponible próximamente');
    }
  };
  ...
  return (
    <section className="bg-white border border-gray-200 rounded-xl shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-b border-gray-100 gap-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Gestión de Grupos</h3>
        ...
        <button
          ...
          title="Exportar grupos (próximamente)"
        >
