...
export const AdminSessionsSection = ({
  sessionsState,
  statusFilter,
  ...
  const handleExport = () => {
    if (onExport) {
      ...
      toast.info('Exportar sesiones', 'La funcionalidad de exportación estará disponible próximamente');
    }
  };
    ...
    <section className="bg-white border border-gray-200 rounded-xl shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between px-6 py-4 border-b border-gray-100 gap-4">
        ...
        <button
          ...
          title="Exportar sesiones (próximamente)"
        >
